...
sh echo "*** Starting iperf3 servers on h3 and h4..."
h3 iperf3 -s -D
h4 iperf3 -s -D

sh echo "*** Generating Steady Traffic (h1 -> h4) at 20Mbps for 15s..."
h1 iperf3 -c 10.0.0.4 -t 15 -b 20M

sh echo "*** Generating Bursty Traffic (h2 -> h3)..."
# Burst 1
...
sh echo "*** Generating Ramping Traffic (h1 -> h4)..."
...
sh echo "*** Traffic generation complete!"
